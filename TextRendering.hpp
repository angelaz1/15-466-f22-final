...
class TextRenderer {
    public: 
        ...
        void renderLine(std::string &line, float x, float y, float scale, glm::vec4 color);
        ...
        void renderText(std::vector<std::string> &lines, float x, float y, float scale, glm::vec4 color);
        // render two lines with different colors
        void renderTextAB(std::string line_a, std::string line_b, float x, float y, float scale, glm::vec4 color_a, glm::vec4 color_b);
